package com.rel.doazikirapp.model
...
object DataDoaDzikir {
    ...
    fun listDziksir(): List<DoaDzikirItem> {
        val dataDzikir = arrayListOf<DoaDzikirItem>()
        for (i in descDzikir.indices) {
            val dzikir = DoaDzikirItem(descDzikir[i], lafazDzikir[i], terjemahDzikir[i])
    ...
    fun listDzikirPagi(): List<DoaDzikirItem> {
        ...
        for (i in descDzikirPagi.indices) {
            val dzikirPagi = DoaDzikirItem(descDzikirPagi[i], lafazDzikirPagi[i], terjemahDzikirPagi[i])
    ...
    fun listDzikirPetang(): List<DoaDzikirItem> {
        ...
        for (i in descDzikirPetang.indices) {
            val dzikirPetang = DoaDzikirItem(descDzikirPetang[i], lafazDzikirPetang[i], terjemahDzikirPetang[i])
